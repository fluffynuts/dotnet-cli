...
import { clearCaches, DotNetCache, listNugetSources, searchPackages, searchPackagesUncached } from "../src";
...
`.trim()
                        ...
                        // Act
                        process.env.DEBUG = "*";
                        await expect(searchPackagesUncached({
                                source: "github",
                                configFile,
                                exactMatch: true,
                                search: "Codeo.Core"
...
`.trim()
    ...
    beforeEach(async () => {
        ...
        await clearCaches(DotNetCache.temp);
    });
    afterAll(async () => {
